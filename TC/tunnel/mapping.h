...
extern struct ecitem* public4over6_ecitem_lookup(struct net_device *dev,struct in_addr *remote, unsigned short portNum);
...
extern struct ecitem* public4over6_ecitem_unlink(struct net_device *dev,struct in_addr *remote,unsigned short pset_index, unsigned short pset_mask, int tag);
